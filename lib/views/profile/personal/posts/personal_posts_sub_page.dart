...
class PersonalProfilePostSubPage extends StatefulWidget {
  const PersonalProfilePostSubPage({
    Key? key,
  ...
  @override
  State<PersonalProfilePostSubPage> createState() =>
      _PersonalProfilePostSubPageState();
}

class _PersonalProfilePostSubPageState
    extends State<PersonalProfilePostSubPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PersonalProfilePageProvider>(
      builder: (context, socialProvider, child) {
        return SliverList(
          delegate: SliverChildBuilderDelegate(
            childCount: socialProvider.feedsList.length,
            (context, index) {
              var feed = socialProvider.feedsList[index];
              return Container(
                width: deviceWidth,
                          ...
                          SizedBox(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Visibility(
                                  visible:
                                      feed.images!.length > 1 ? true : false,
                                  child: Positioned(
                                    top: 231,
                                    right: 20,
                                    child: IgnorePointer(
