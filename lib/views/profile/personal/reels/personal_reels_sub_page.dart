...
class PersonalProfileReelsSubPage extends StatefulWidget {
  const PersonalProfileReelsSubPage({
    Key? key,
                ...
                child: Center(
                  child: (socialProvider.reelsList[index].videos!.isNotEmpty &&
                      ...
                      ? CachedNetworkImage(
                          ...
                          imageUrl: socialProvider.reelsList[index].videos![0]!.image ?? 'https://static.vecteezy.com/system/resources/previews/005/337/799/original/icon-image-not-found-free-vector.jpg',
