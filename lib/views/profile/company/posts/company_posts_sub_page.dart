...
class CompanyProfilePostSubPage extends StatefulWidget {
  const CompanyProfilePostSubPage({
    Key? key,
  ...
  @override
  State<CompanyProfilePostSubPage> createState() =>
      _CompanyProfilePostSubPageState();
}

class _CompanyProfilePostSubPageState extends State<CompanyProfilePostSubPage> {
