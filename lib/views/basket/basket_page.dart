                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child: MaterialButton(
                                                                            ...
                                                                            elevation: 0,
                                                                            child: Text(
                                                                              selectedAddressIndex == index ? 'Chosen'.tr : 'Choose'.tr,
                                                                              style: TextStyle(fontSize: 12, fontFamily: AppTheme.appFontFamily, fontWeight: FontWeight.w700, color: AppTheme.white1),
                                                                            ),
                                                                            onPressed: () {
