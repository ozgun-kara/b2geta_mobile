...
class MyAccountPostPage extends StatefulWidget {
  const MyAccountPostPage({
    Key? key,
  ...
  @override
  State<MyAccountPostPage> createState() => _MyAccountPostPageState();
}

class _MyAccountPostPageState extends State<MyAccountPostPage> {
