...
class RegisterPageCopy extends StatefulWidget {
  const RegisterPageCopy({Key? key}) : super(key: key);

  @override
  State<RegisterPageCopy> createState() => _RegisterPageCopyState();
}

class _RegisterPageCopyState extends State<RegisterPageCopy> {
